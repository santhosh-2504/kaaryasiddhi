...
const steps = [
  {
    ...
    description:
      "Whether you're a beginner or a pro, you start where you are and grow steadily.",
    icon: GraduationCap,
  },
  {
    title: "Complete Real-World Tasks",
    description:
      "Submit projects, screenshots, links, or files. Everything is reviewed manually.",
    icon: ClipboardCheck,
  },
  {
    title: "Build Your GitHub & LinkedIn Profile",
    description:
      "We personally help you build strong online presence that recruiters love.",
    icon: Github,
  },
  {
    title: "Track Progress with Levels & Streaks",
    description:
      "Motivation meets accountability with our level system and daily streaks.",
    icon: TrendingUp,
  },
  {
    title: "Get Mentored, Not Just Taught",
    description:
      "One-on-one guidance, feedback, and goal tracking to stay on course.",
    icon: Users,
  },
];
...
const HowItWorks = () => {
  return (
    <section
      id="how-it-works"
      className="bg-gradient-to-br from-white via-emerald-50 to-slate-50 dark:from-slate-800 dark:via-slate-900 dark:to-slate-800 py-20 w-full"
      aria-label="How KaaryaSiddhi Works"
    >
      <div className="w-full px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 text-center mb-16 max-w-3xl mx-auto">
            Our structured approach ensures every student gets personalized
