...
>
            ...
            <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-emerald-50 to-slate-50 dark:from-slate-800 dark:to-slate-900 border-b border-slate-200 dark:border-slate-700">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center shadow-lg">
                      ...
                      <div className={`rounded-2xl px-3 sm:px-4 py-2 sm:py-3 shadow-sm transition-all duration-300 hover:shadow-md ${
                        ...
                        {msg.role === "assistant" ? (
                          <ReactMarkdown
                            components={{
                              h3: ({ children }) => (
                                <h3 className="text-sm sm:text-base font-semibold mt-2 mb-1 text-slate-800 dark:text-white">
                                  {children}
                                </h3>
                              ),
                              strong: ({ children }) => (
                              ...
                              p: ({ children }) => (
                                <p className="leading-relaxed text-xs sm:text-sm my-1 text-slate-700 dark:text-slate-300">
                                  {children}
                                </p>
                              ),
                              code: ({ children }) => (
            ...
            <div className="border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-3 sm:p-4">
              <div className="flex items-end gap-2 sm:gap-3">
                ...
                <button
                  onClick={handleSend}
                  disabled={!input.trim() || loading}
                  className="bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 disabled:from-slate-400 disabled:to-slate-500 text-white p-2.5 sm:p-3 mb-1 sm:mb-2 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed"
                  aria-label="Send message"
                >
