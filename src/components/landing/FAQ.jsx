  ...
  const faqData = [
    {
      ...
      answer:
        "KaaryaSiddhi is a mentorship platform that guides students from basic to advanced levels in full stack development and essential professional skills like resume building, GitHub activity, and LinkedIn visibility.",
    },
    {
      question: "Who is this mentorship for?",
      answer:
        "This is designed for B.Tech students of all years, especially beginners with no prior experience in coding or tech.",
    },
    {
      question:
        "How is this different from online courses on YouTube or Udemy?",
      answer:
        "We don’t just teach. We mentor you personally, help you stay consistent, validate your progress, review your profiles, and track your real growth with projects, tasks, and feedback.",
    },
    {
      question: "Do I need to know JavaScript already?",
      answer:
        "No. We start from scratch — including HTML, CSS, and JavaScript — and build up gradually to full stack development using MERN.",
    },
    {
      question: "What if I’m unable to complete tasks regularly?",
      answer:
        "There’s no pressure. You can request a ‘freeze’ if you're genuinely stuck. We focus on consistency, not rush.",
    },
    {
      question: "Is there a trial or demo before paying?",
      answer:
        "You can explore our Level 0 tasks and entire platform before joining the paid mentorship.",
    },
    {
      question: "Will I get help with internships or job placements?",
      answer:
        "Yes. Once you reach advanced levels and have a solid portfolio, we guide you on applying, networking, and building a strong profile for internships and jobs.",
    },
    {
      question: "Is this mentorship in-person or online?",
      answer:
        "It’s fully online and flexible. You submit tasks at your pace, and we provide regular reviews and check-ins.",
    },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-12">
            ...
            <button
              className="px-8 py-3 text-lg font-semibold text-white bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-600 dark:hover:bg-emerald-500 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              onClick={() =>
                window.open(
