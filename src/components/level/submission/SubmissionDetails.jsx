      ...
      <div className="space-y-2 sm:space-y-3">
              ...
              <div className="flex-1 xs:w-20 bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                <div 
                  className={`h-2 rounded-full transition-all duration-300 ${
                    submission.score >= 7 ? 'bg-green-500' : 
                    submission.score >= 5 ? 'bg-yellow-500' : 'bg-red-500'
                  }`}
        ...
        {submission.remarks && (
          <div className="space-y-1">
            <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Remarks:</span>
