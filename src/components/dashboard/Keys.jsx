...
//   useEffect(() => {
//     let stored = JSON.parse(localStorage.getItem("rapidapi_keys")) || [];

//     // Migrate old strings
//     if (stored.length && typeof stored[0] === "string") {
//       stored = stored.map((k, i) => ({
//         label: `Key ${i + 1}`,
//         key: k,
//         usedToday: 0,
//         lastUsed: today,
//       }));
//       localStorage.setItem("rapidapi_keys", JSON.stringify(stored));
//     }

//     let selected = parseInt(localStorage.getItem("selected_rapidapi_key_index"), 10);
//     if (!Number.isInteger(selected) || selected >= stored.length) {
//       selected = null;
...
//     localStorage.setItem("selected_rapidapi_key_index", index);
...
//     try {
//       const res = await fetch("https://ip-geolocation-ipwhois-io.p.rapidapi.com/json/", {
//         headers: {
...
//       localStorage.setItem("selected_rapidapi_key_index", 0); // default to first key
//       setSelectedIndex(0);
//     } else if (index < selectedIndex) {
//       // Shift selected index back by 1
//       const newIndex = selectedIndex - 1;
//       localStorage.setItem("selected_rapidapi_key_index", newIndex);
...
//               <table className="w-full bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md">
//                 <thead>
...
//                     const isToday = item.lastUsed === today;
//                     const used = isToday ? item.usedToday : 0;
