        ...
        <form onSubmit={handleLogin}>
          ...
          <p className="text-center mt-4 text-sm text-gray-600 dark:text-gray-400">
            ...
            <button
              ...
              className="text-sm hover:underline text-emerald-600 hover:text-emerald-800 dark:text-emerald-400 dark:hover:text-emerald-300"
            >
              Forgot Password?
            </button>
          </p>
            ...
            <form onSubmit={handleVerifyOTP}>
              ...
              <div className="flex justify-end gap-4">
                <button
                  ...
                  className="px-4 py-2 text-emerald-600 hover:text-emerald-800 disabled:opacity-50 dark:text-emerald-400 dark:hover:text-emerald-300"
                >
                  Resend OTP
                </button>
                <button
