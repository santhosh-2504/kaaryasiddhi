...
export default function AdminPage() {
  ...
  const { data, loading, error, metadata, filters } = useSelector(
  ...
  if (loading)
    return <p className="text-center py-8">Loading dashboard data...</p>;
  if (error)
          ...
          {metadata && (
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="text-sm text-gray-600 bg-gray-50 px-4 py-2 rounded-lg">
                ...
                Showing {filteredData.length} user
                ...
                {metadata.appliedFilters.levelFilter !== null && (
                  <span>
                    ...
                    at{" "}
                    <span className="font-medium text-gray-800">
                      level {metadata.appliedFilters.levelFilter}
                    </span>
                  </span>
                )}
                <span>
                  ...
                  from last{" "}
                  <span className="font-medium text-gray-800">
                    {metadata.appliedFilters.daysBack} day
                    {metadata.appliedFilters.daysBack > 1 ? "s" : ""}
                  </span>
                </span>
              </div>
            </div>
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="ml-2 flex-1 bg-gray-200 rounded-full h-2 w-16">
                              <div
                                ...
                                style={{
                                  width: `${Math.min((user.avgLinkedinScore / 10) * 100, 100)}%`,
                                }}
                              ></div>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="ml-2 flex-1 bg-gray-200 rounded-full h-2 w-16">
                              <div
                                ...
                                style={{
                                  width: `${Math.min((user.avgGithubScore / 10) * 100, 100)}%`,
                                }}
                              ></div>
                            </div>
                          </div>
